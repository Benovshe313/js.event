...
let goods = [
  ...
  let ModaDünyası = document.getElementById('b1')
  let ZərifModa = document.getElementById('b2')
  let ƏliyevModaMərkəzi = document.getElementById('b3')
  ...
  function filterByStore(storeName){
    let filteredList = goods.filter(prod => prod.store_name === storeName)      
    getArray(filteredList)                   
  }

  document.getElementById('b1').addEventListener('click',() => {
    filterByStore('Moda Dünyası')
  })

  document.getElementById('b2').addEventListener('click',() => {
    filterByStore('Zərif Moda')
  })

  document.getElementById('b3').addEventListener('click',() => {
    filterByStore('Əliyev Moda Mərkəzi')
  })